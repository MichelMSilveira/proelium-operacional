...
export default function QualityPage() {
  const { data, error, loading } = useApi<{ data?: { evaluations?: Item[] } }>('/api/data');
  const items = data?.data?.evaluations || [];
